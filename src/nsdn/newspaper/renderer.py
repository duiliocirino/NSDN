...
class Renderer:
    ...
    def to_pdf(self, html: str, css: str) -> bytes:
        ...
        pdf_bytes = doc.write_pdf(presentation={
            "@page": {
                "size": format_size,
                "margin": margin,
            },
    ...
    @staticmethod
    def _combine_html_css(html: str, css: str) -> str:
